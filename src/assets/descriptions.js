const attributes = [
  'ID, n_age, c_workclass, s_fnlwgt:, c_education:, n_education-num:, c_marital-status:, c_occupation:, c_relationship:, c_race, c_sex:, s_capital-gain:, s_capital-loss:, n_hours-per-week:, c_native-country:, c_class'
]
